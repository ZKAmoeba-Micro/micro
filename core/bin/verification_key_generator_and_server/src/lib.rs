...
use micro_types::vk_transform::generate_vk_commitment;
use micro_types::zkevm_test_harness::witness;
use micro_types::zkevm_test_harness::witness::full_block_artifact::BlockBasicCircuits;
use micro_types::zkevm_test_harness::witness::recursive_aggregation::{
...
) -> HashMap<u8, VerificationKey<Bn256, MicroCircuit<Bn256, VmWitnessOracle<Bn256>>>> {
...
pub fn get_vk_for_circuit_type(
    circuit_type: u8,
) -> VerificationKey<Bn256, MicroCircuit<Bn256, VmWitnessOracle<Bn256>>> {
    ...
    serde_json::from_str::<VerificationKey<Bn256, MicroCircuit<Bn256, VmWitnessOracle<Bn256>>>>(
        &text,
    )
    .unwrap_or_else(|_| {
        panic!(
...
pub fn save_vk_for_circuit_type(
    circuit_type: u8,
    vk: VerificationKey<Bn256, MicroCircuit<Bn256, VmWitnessOracle<Bn256>>>,
) {
    let filepath = get_file_path(circuit_type);
...
pub fn get_ordered_vks_for_basic_circuits(
    ...
    verification_keys: &HashMap<
        ...
        VerificationKey<Bn256, MicroCircuit<Bn256, VmWitnessOracle<Bn256>>>,
    >,
) -> Vec<VerificationKey<Bn256, MicroCircuit<Bn256, VmWitnessOracle<Bn256>>>> {
    circuits
        .clone()
        .into_flattened_set()
        .iter()
...
pub fn get_circuits_for_vk() -> Vec<MicroCircuit<Bn256, VmWitnessOracle<Bn256>>> {
