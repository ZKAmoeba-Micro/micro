...
use micro_prover_utils::{get_stop_signal_receiver, wait_for_tasks};
...
async fn main() {
    ...
    let micro_config = MicroConfig::from_env();
    ...
    let tasks = vec![
        run_prometheus_exporter(micro_config.api.prometheus, use_push_gateway),
