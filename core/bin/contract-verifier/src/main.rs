...
async fn update_compiler_versions(connection_pool: &ConnectionPool) {
    ...
    let zksolc_path = format!("{}/etc/zksolc-bin/", micro_home);
    ...
    let solc_path = format!("{}/etc/solc-bin/", micro_home);
    ...
    let zkvyper_path = format!("{}/etc/zkvyper-bin/", micro_home);
    ...
    let vyper_path = format!("{}/etc/vyper-bin/", micro_home);
