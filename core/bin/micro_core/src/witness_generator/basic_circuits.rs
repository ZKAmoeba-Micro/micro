...
use micro_db_storage_provider::DbStorageProvider;
use micro_object_store::{Bucket, ObjectStore, ObjectStoreFactory, StoredObject};
use micro_queued_job_processor::JobProcessor;
use micro_state::storage_view::StorageView;
use micro_types::zkevm_test_harness::toolset::GeometryConfig;
use micro_types::{
...
pub struct BasicCircuitArtifacts {
    ...
    circuits: Vec<MicroCircuit<Bn256, VmWitnessOracle<Bn256>>>,
}
...
pub fn generate_witness(
    ...
    micro_types::zkevm_test_harness::external_calls::run_with_fixed_params(
        Address::zero(),
        BOOTLOADER_ADDRESS,
        bootloader_code,
        bootloader_contents,
