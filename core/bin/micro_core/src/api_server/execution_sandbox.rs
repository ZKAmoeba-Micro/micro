...
use micro_types::{PUBLISH_BYTECODE_OVERHEAD, TRUSTED_ADDRESS_SLOTS, TRUSTED_TOKEN_SLOTS};
use micro_utils::bytecode::{bytecode_len_in_bytes, hash_bytecode, CompressedBytecodeInfo};
...
fn execute_tx_in_sandbox(
    ...
    operator_account: AccountTreeId,
    block_id: api::BlockId,
    resolved_block_number: micro_types::MiniblockNumber,
