//! Helper module to submit transactions into the micro Network.
// Built-in uses
...
use micro_dal::transactions_dal::L2TxSubmissionResult;
...
use micro_utils::{bytes_to_be_words, h256_to_u256};
...
/// This structure is detached from `MicroConfig`, since different node types (main, external, etc)
...
impl From<MicroConfig> for TxSenderConfig {
    fn from(config: MicroConfig) -> Self {
        Self {
