...
use micro_types::event::extract_bytecodes_marked_as_known;
use micro_types::l2_to_l1_log::L2ToL1Log;
use micro_types::tx::tx_execution_info::VmExecutionLogs;
use micro_types::tx::ExecutionMetrics;
use micro_types::{tx::TransactionExecutionResult, StorageLogQuery, Transaction, VmEvent, H256};
...
mod tests {
    use super::*;
    use micro_types::{l2::L2Tx, tx::tx_execution_info::TxExecutionStatus, Address, Nonce, U256};
