...
pub(self) use micro_config::configs::chain::StateKeeperConfig;
...
use micro_utils::time::{millis_since, millis_since_epoch};
use std::fmt::Debug;
...
pub enum SealResolution {
    ...
    /// Micro. We may not know, for example, how much gas block will consume, because 1) smart contract
