//! This module applies updates to the MicroTree, calculates metadata for sealed blocks, and
...
use micro_config::{DBConfig, MicroConfig};
use micro_dal::{ConnectionPool, StorageProcessor};
use micro_merkle_tree::TreeMetadata;
...
impl MetadataCalculator {
    ...
    /// witness inputs.
    pub fn lightweight(config: &MicroConfig, implementation: TreeImplementation) -> Self {
