...
#[derive(Debug, Parser)]
#[command(author = "", version, about = "micro operator node", long_about = None)]
struct Cli {
    ...
    #[arg(
        long,
        default_value = "api,tree,eth,data_fetcher,state_keeper,witness_generator,housekeeper,l2_sender,assignments"
    )]
