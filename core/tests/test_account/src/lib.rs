...
// Workspace uses
use micro_crypto::rand::{thread_rng, Rng};
use micro_types::{
...
/// Structure used to sign Micro transactions, keeps tracks of its nonce internally
pub struct MicroAccount {
    pub private_key: H256,
    pub address: Address,
    nonce: Mutex<Nonce>,
}

impl Clone for MicroAccount {
    fn clone(&self) -> Self {
        Self {
