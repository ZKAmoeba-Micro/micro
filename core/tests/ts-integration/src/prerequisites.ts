...
// All micro test suites are expected to be named `*.test.ts`.
...
/**
 * Gets all the files that contain micro integration test suites.
 * Used to provide each test suite a funded wallet.
 *
 * @returns list of filenames that correspond to micro integration test suites.
 */
