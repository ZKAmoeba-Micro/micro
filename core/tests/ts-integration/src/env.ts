...
export async function loadTestEnvironment(): Promise<TestEnvironment> {
    ...
    const contractVerificationUrl = process.env.MICRO_ENV!.startsWith('ext-node')
