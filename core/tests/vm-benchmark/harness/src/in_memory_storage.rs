use micro_types::{
    get_code_key, get_system_context_init_logs, storage::MicroReadStorage,
...
impl Default for InMemoryStorage {
    fn default() -> Self {
        ...
        let system_context_init_log = get_system_context_init_logs(L2ChainId(380));
...
impl MicroReadStorage for &InMemoryStorage {
