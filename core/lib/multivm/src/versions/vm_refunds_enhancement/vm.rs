...
use micro_types::{l2_to_l1_log::UserL2ToL1Log, Transaction};
...
use crate::{
    ...
    vm_refunds_enhancement::{
        ...
        types::internals::{new_vm_state, MicroVmState, VmSnapshot},
    },
    HistoryMode,
};
...
pub struct Vm<S: WriteStorage, H: HistoryMode> {
    ...
    pub(crate) state: MicroVmState<S, H::VmVirtualBlocksRefundsEnhancement>,
