...
use micro_utils::{bytes_to_be_words, h256_to_u256, u256_to_h256};

use crate::vm_refunds_enhancement::types::internals::MicroVmState;
...
pub(crate) fn verify_required_storage<H: HistoryMode>(
    state: &MicroVmState<InMemoryStorageView, H>,
