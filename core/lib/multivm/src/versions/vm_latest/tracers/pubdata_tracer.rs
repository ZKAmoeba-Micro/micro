...
use micro_utils::{h256_to_u256, u256_to_bytes_be, u256_to_h256};
use zk_evm_1_4_0::{
...
use crate::{
    ...
    vm_latest::{
        ...
        types::internals::{pubdata::PubdataInput, MicroVmState},
...
impl<S: WriteStorage> PubdataTracer<S> {
    ...
    fn build_pubdata_input<H: HistoryMode>(&self, state: &MicroVmState<S, H>) -> PubdataInput {
        PubdataInput {
