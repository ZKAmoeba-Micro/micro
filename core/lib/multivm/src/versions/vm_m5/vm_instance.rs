...
use micro_system_constants::MAX_TXS_IN_BLOCK;
use micro_types::{
...
pub type MicroVmState<S> = VmState<
    StorageOracle<S>,
    SimpleMemory,
    InMemoryEventSink,
...
// has failed.
pub(crate) fn tx_has_failed<S: Storage>(state: &MicroVmState<S>, tx_id: u32) -> bool {
