...
use micro_system_constants::KECCAK256_PRECOMPILE_ADDRESS;
use micro_types::{
    get_code_key, vm_trace::ViolatedValidationRule, AccountTreeId, StorageKey, H256,
};
use micro_utils::{h256_to_account_address, u256_to_account_address, u256_to_h256};
use zk_evm_1_3_3::{
...
use crate::{
    ...
    vm_refunds_enhancement::{
        ...
        BootloaderState, MicroVmState, SimpleMemory, VmTracer,
    },
    HistoryMode,
};
    ...
    for ValidationTracer<H>
{
    fn finish_cycle(
        &mut self,
        _state: &mut MicroVmState<S, H::VmVirtualBlocksRefundsEnhancement>,
