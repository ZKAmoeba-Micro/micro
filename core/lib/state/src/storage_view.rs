...
use micro_types::{MicroReadStorage, StorageKey, StorageValue, H256};
use std::fmt::Debug;
...
/// to `MicroStorage` after transaction is executed.
...
impl<S: MicroReadStorage> StorageView<S> {
...
mod test {
    ...
    use micro_types::{AccountTreeId, Address, H256};
