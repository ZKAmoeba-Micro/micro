use micro_storage::db::StateKeeperColumnFamily;
use micro_storage::rocksdb::WriteBatch;
use micro_storage::util::{deserialize_block_number, serialize_block_number};
use micro_storage::RocksDB;
use micro_types::{
    L1BatchNumber, MicroReadStorage, StorageKey, StorageLog, StorageLogKind, StorageValue, H256,
};
...
impl MicroReadStorage for &SecondaryStateStorage {
