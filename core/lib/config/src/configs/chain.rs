...
// Local uses
use micro_basic_types::network::Network;
...
pub struct StateKeeperConfig {
    ...
    ///The heartbeat path of L2 layer nodes.
    pub l2_node_heart_beat_url: String,
}
    ...
    fn expected_config() -> ChainConfig {
        ChainConfig {
            eth: Eth {
                ...
                micro_network: "localhost".to_string(),
                micro_network_id: 380,
            },
            state_keeper: StateKeeperConfig {
                ...
                l2_node_heart_beat_url: String::from("127.0.0.1:3052"),
            },
...
CHAIN_ETH_MICRO_NETWORK="localhost"
CHAIN_ETH_MICRO_NETWORK_ID=380
...
CHAIN_STATE_KEEPER_L2_NODE_HEART_BEAT_URL="127.0.0.1:3052"
