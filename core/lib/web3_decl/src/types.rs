...
//!
//! These "extensions" are required to provide more micro-specific information while remaining Web3-compilant.
...
pub enum TypedFilter {
    Events(Filter, micro_types::MiniblockNumber),
    Blocks(micro_types::MiniblockNumber),
...
mod tests {
    use super::*;
    use micro_types::api::{BlockId, BlockIdVariant};
