//! Implementation of Micro's peer management system.

use crate::lru_cache::LRUTimeCache;
...
impl PeerManager {
    ...
    /// This prioritises peers with a good score and uniform distribution of peers.
