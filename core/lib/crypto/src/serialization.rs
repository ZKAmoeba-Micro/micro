...
// ///
// /// ```
// /// use micro_crypto::serialization::FrSerde;
// /// use micro_crypto::Fr;
...
// ///
// /// ```
// /// use micro_crypto::serialization::OptionalFrSerde;
// /// use micro_crypto::Fr;
// /// use serde::{Serialize, Deserialize};
// ///
// /// #[derive(Clone, Debug, Serialize, Deserialize)]
...
// ///
// /// ```
// /// use micro_crypto::serialization::VecOptionalFrSerde;
// /// use micro_crypto::Fr;
// /// use serde::{Serialize, Deserialize};
// ///
// /// #[derive(Clone, Debug, Serialize, Deserialize)]
...
// ///
// /// ```
// /// use micro_crypto::serialization::VecFrSerde;
// /// use micro_crypto::Fr;
// /// use serde::{Serialize, Deserialize};
// ///
// /// #[derive(Clone, Debug, Serialize, Deserialize)]
