use micro_config::configs::eth_sender::{ProofLoadingMode, ProofSendingMode, SenderConfig};
use micro_contracts::BaseSystemContractsHashes;
use micro_dal::StorageProcessor;
use micro_object_store::ObjectStore;
use micro_prover_utils::gcs_proof_fetcher::load_wrapped_fri_proofs_for_range;
use micro_types::{
