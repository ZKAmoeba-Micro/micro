...
use micro_types::protocol_version::{ProtocolUpgradeTx, ProtocolUpgradeTxCommonData};
use micro_types::web3::types::{Address, BlockNumber};
use micro_types::{
...
fn upgrade_into_log(upgrade: ProtocolUpgrade, eth_block: u64) -> Log {
    ...
    let execute_upgrade_selector = micro_contract()
