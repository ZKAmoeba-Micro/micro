...
use micro_types::{L1BatchNumber, MiniblockNumber, H256};
use micro_web3_decl::jsonrpsee::core::Error as RpcError;
use micro_web3_decl::RpcResult;
...
impl MainNodeFetcher {
    ...
    async fn fetch_next_miniblock(&mut self) -> RpcResult<bool> {
        ...
        let txs: Vec<micro_types::Transaction> = block
            .transactions
