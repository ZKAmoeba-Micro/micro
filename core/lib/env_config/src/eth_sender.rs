...
use micro_config::{configs::eth_sender::SenderConfig, ETHSenderConfig, GasAdjusterConfig};
...
#[cfg(test)]
mod tests {
    use micro_config::configs::eth_sender::{ProofLoadingMode, ProofSendingMode};
