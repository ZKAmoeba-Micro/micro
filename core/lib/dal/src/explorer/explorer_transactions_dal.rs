...
use micro_config::constants::ERC20_TRANSFER_TOPIC;
use micro_types::api::Log;
use micro_types::explorer_api::{
    ...
    fn get_withdrawals(
        ...
        async_std::task::block_on(async {
            static ERC20_WITHDRAW_EVENT_SIGNATURE: Lazy<H256> = Lazy::new(|| {
                micro_contracts::l2_bridge_contract()
