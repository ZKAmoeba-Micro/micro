...
use micro_types::commitment::{BlockWithMetadata, CommitmentSerializable};

use micro_types::MAX_GAS_PER_PUBDATA_BYTE;
...
impl BlocksDal<'_, '_> {
    ...
    pub fn get_block_counts_for_eth_tx_id(&mut self, eth_tx_id: u32) -> u32 {
        async_std::task::block_on(async {
