...
pub type MicroVmState<'a, H> = VmState<
    'a,
    StorageOracle<'a, H>,
    SimpleMemory<H>,
    InMemoryEventSink<H>,
...
fn vm_may_have_ended_inner<H: HistoryMode>(vm: &MicroVmState<H>) -> Option<NewVmExecutionResult> {
...
// has failed.
pub(crate) fn tx_has_failed<H: HistoryMode>(state: &MicroVmState<'_, H>, tx_id: u32) -> bool {
