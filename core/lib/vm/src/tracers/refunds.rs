...
use crate::constants::{
    BOOTLOADER_HEAP_PAGE, OPERATOR_REFUNDS_OFFSET, TX_GAS_LIMIT_OFFSET, TX_MAX_FEE_PER_GAS_OFFSET,
    TX_MAX_PRIORITY_PER_FEE_OFFSET, TX_TYPE_OFFSET,
};
use crate::old_vm::{
...
impl<S: WriteStorage, H: HistoryMode> ExecutionProcessing<S, H> for RefundsTracer {
    ...
    fn before_cycle(&mut self, state: &mut MicroVmState<S, H>) {
