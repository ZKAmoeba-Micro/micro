...
use micro_utils::{h256_to_u256, u256_to_bytes_be};
...
use crate::types::{inputs::L1BatchEnv, internals::MicroVmState};
use crate::{
...
impl<S: WriteStorage, H: HistoryMode> ExecutionProcessing<S, H> for PubdataTracer {
    ...
    fn before_cycle(&mut self, _state: &mut MicroVmState<S, H>) {}
