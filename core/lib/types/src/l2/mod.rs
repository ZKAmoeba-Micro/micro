...
pub enum TransactionType {
    ...
    // Eip 712 transaction with additional fields specified for micro
...
pub struct L2TxCommonData {
    ...
    /// But we still use this structure for micro-rs and tests, and we don't have raw tx before
...
#[cfg(test)]
mod tests {
    use micro_basic_types::{Nonce, U256};
