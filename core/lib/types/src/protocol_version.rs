...
impl ProtocolVersionId {
    ...
    pub fn into_api_vm_version(self) -> VmVersion {
        match self {
            ...
            ProtocolVersionId::Version22 => VmVersion::VmBoojumIntegration,
            ProtocolVersionId::Version23 => VmVersion::VmBoojumIntegration,
        }
    }
...
pub struct ProtocolUpgradeTxCommonData {
    ...
    /// Block in which Ethereum transaction was included.
    pub eth_block: u64,
    /// Tx hash of the transaction in the micro network. Calculated as the encoded transaction data hash.
