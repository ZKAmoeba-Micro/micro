...
use micro_basic_types::{L1BatchNumber, H256, U256};
...
pub struct WitnessGeneratorJobMetadata {
    ...
    pub proofs: Vec<Proof<Bn256, MicroCircuit<Bn256, VmWitnessOracle<Bn256>>>>,
}
...
pub struct PrepareLeafAggregationCircuitsJob {
    ...
    pub basic_circuits_proofs: Vec<Proof<Bn256, MicroCircuit<Bn256, VmWitnessOracle<Bn256>>>>,
}

#[derive(Clone)]
pub struct PrepareNodeAggregationCircuitJob {
    pub previous_level_proofs: Vec<Proof<Bn256, MicroCircuit<Bn256, VmWitnessOracle<Bn256>>>>,
...
pub struct PrepareSchedulerCircuitJob {
    ...
    pub node_final_proof_level_proof: Proof<Bn256, MicroCircuit<Bn256, VmWitnessOracle<Bn256>>>,
