...
use micro_basic_types::{H2048, H256, U256};
use micro_contracts::BaseSystemContractsHashes;
use micro_system_constants::SYSTEM_BLOCK_INFO_BLOCK_NUMBER_MULTIPLIER;
...
impl MiniblockHasher {
    /// At the beginning of the micro, the hashes of the blocks could be calculated as the hash of their number.
