...
use micro_basic_types::{L1BatchNumber, MiniblockNumber, H256};
...
/// See `micro_dal::models::storage_sync::ConsensusBlockFields`.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
#[serde(transparent)]
pub struct ConsensusBlockFields(pub micro_basic_types::Bytes);
