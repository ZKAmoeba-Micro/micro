...
uint256 constant CURRENT_MAX_PRECOMPILE_ADDRESS = uint256(
    uint160(SHA256_SYSTEM_CONTRACT)
);
...
IEthToken constant ETH_TOKEN_SYSTEM_CONTRACT = IEthToken(
    address(SYSTEM_CONTRACTS_OFFSET + 0x0a)
);

address constant KECCAK256_SYSTEM_CONTRACT = address(
...
address constant EVENT_WRITER_CONTRACT = address(
    SYSTEM_CONTRACTS_OFFSET + 0x0d
);
...
address constant FEE_POOL_ADDRESS = payable(
    address(SYSTEM_CONTRACTS_OFFSET + 0x101)
);

address constant PROOF_REWARD_POOL_ADDRESS = address(
    SYSTEM_CONTRACTS_OFFSET + 0x102
);

address constant DAO_ADDRESS = payable(
    address(SYSTEM_CONTRACTS_OFFSET + 0x103)
);

address constant PROOF_REWARD_POOL_CALLER_ADDRESS = payable(
    address(SYSTEM_CONTRACTS_OFFSET + 0x104)
);
