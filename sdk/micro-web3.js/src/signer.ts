...
// const microProvider = new zkweb3.Provider('<rpc_url>');
// const signer = zkweb3.L1Signer.from(provider.getSigner(), microProvider);
...
export class L1Signer extends AdapterL1(ethers.providers.JsonRpcSigner) {
    ...
    static from(signer: ethers.providers.JsonRpcSigner, microProvider: Provider): L1Signer {
        const newSigner: L1Signer = Object.setPrototypeOf(signer, L1Signer.prototype);
        newSigner.providerL2 = microProvider;
        return newSigner;
    }
...
export class L1VoidSigner extends AdapterL1(ethers.VoidSigner) {
    ...
    static from(signer: ethers.VoidSigner, microProvider: Provider): L1VoidSigner {
