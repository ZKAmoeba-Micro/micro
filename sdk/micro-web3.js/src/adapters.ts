...
import { IERC20MetadataFactory, IL1BridgeFactory, IL2BridgeFactory, IMicroFactory } from '../typechain';
...
export function AdapterL1<TBase extends Constructor<TxSender>>(Base: TBase) {
    return class Adapter extends Base {
        ...
        async getMainContract() {
            ...
            return IMicroFactory.connect(address, this._signerL1());
        }
        ...
        async getBaseCost(params: {
            ...
            const microContract = await this.getMainContract();
            ...
            return BigNumber.from(
                await microContract.l2TransactionBaseCost(
                    parameters.gasPrice,
                    parameters.gasLimit,
        ...
        async getDepositTx(transaction: {
            ...
            const baseCost = await microContract.l2TransactionBaseCost(
        ...
        async finalizeWithdrawal(withdrawalHash: BytesLike, index: number = 0, overrides?: ethers.Overrides) {
            ...
            if (isETH(sender)) {
                ...
                const micro = IMicroFactory.connect(contractAddress, this._signerL1());

                return await micro.finalizeEthWithdrawal(
                    l1BatchNumber,
                    l2MessageIndex,
                    l2TxNumberInBlock,
                    message,
        ...
        async isWithdrawalFinalized(withdrawalHash: BytesLike, index: number = 0) {
            ...
            if (isETH(sender)) {
                ...
                return await micro.isEthWithdrawalFinalized(log.l1BatchNumber, proof.id);
            }
        ...
        async getRequestExecuteTx(transaction: {
            ...
            return await microContract.populateTransaction.requestL2Transaction(
                contractAddress,
                l2Value,
                calldata,
                l2GasLimit,
