...
describe('L1 ERC20 proxy upgrade fork test', function () {
    ...
    it('should revert on non-existed methods', async () => {
        ...
        const failedGetMailbox = await isPromiseFailed(bridgeProxyAsNewImplementation.getMicroMailbox());
    ...
    it('check new functions', async () => {
        ...
        const mailbox = await bridgeProxyAsNewImplementation.getMicroMailbox();
