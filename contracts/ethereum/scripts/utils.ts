...
const SYSTEM_CONTRACTS_PATH = path.join(process.env.MICRO_HOME as string, `etc/system-contracts`);
const BOOTLOADER_PATH = path.join(process.env.MICRO_HOME as string, `etc/system-contracts/bootloader`);
