...
function functionSelector(functionName: string): string {
    ...
    try {
        selectors.push(micro.getSighash(micro.getFunction(functionName)));
    } catch {}
