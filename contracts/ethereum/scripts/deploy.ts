...
async function main() {
    ...
    program
        ...
        .action(async (cmd) => {
            ...
            await deployer.deployMicroContract(create2Salt, gasPrice, nonce + 1);
            await deployer.deployBridgeContracts(create2Salt, gasPrice); // Do not pass nonce, since it was increment after deploying micro contracts
