...
import { IMicroFactory } from '../typechain/IMicroFactory';
...
export class Deployer {
    ...
    public async initialProxyDiamondCut() {
        const getters = await hardhat.ethers.getContractAt('GettersFacet', this.addresses.Micro.GettersFacet);
        const diamondCutFacet = await hardhat.ethers.getContractAt(
            'DiamondCutFacet',
            this.addresses.Micro.DiamondCutFacet
        );
        const executor = await hardhat.ethers.getContractAt('ExecutorFacet', this.addresses.Micro.ExecutorFacet);
        const governance = await hardhat.ethers.getContractAt('GovernanceFacet', this.addresses.Micro.GovernanceFacet);
        const mailbox = await hardhat.ethers.getContractAt('MailboxFacet', this.addresses.Micro.MailboxFacet);
        ...
        return diamondCut(facetCuts, this.addresses.Micro.DiamondInit, diamondInitCalldata);
    }
    ...
    public async deployCreate2Factory(ethTxOptions?: ethers.providers.TransactionRequest) {
        ...
        if (this.verbose) {
            console.log(`CONTRACTS_CREATE2_FACTORY_ADDR=${rec.contractAddress}`);
            console.log(`Create2 factory deployed, gasUsed: ${rec.gasUsed.toString()}`);
        }

        this.addresses.Create2Factory = rec.contractAddress;
    }
    ...
    private async deployViaCreate2(
        ...
        if (this.verbose) {
            ...
            console.log(
                `${contractName} deployed, gasUsed: ${gasUsed.toString()}, expectedAddress: ${expectedAddress}, hash: ${
                    receipt.transactionHash
                }`
            );
        }
        console.log('sleep for deploy');
        await sleep(60000);
    ...
    public async deployAllowList(create2Salt: string, ethTxOptions: ethers.providers.TransactionRequest) {
        ethTxOptions.gasLimit ??= 200_000_000;
    ...
    public async deployMailboxFacet(create2Salt: string, ethTxOptions: ethers.providers.TransactionRequest) {
        ...
        this.addresses.Micro.MailboxFacet = contractAddress;
    }
    ...
    public async deployGovernanceFacet(create2Salt: string, ethTxOptions: ethers.providers.TransactionRequest) {
        ...
        this.addresses.Micro.GovernanceFacet = contractAddress;
    }
    ...
    public async deployDiamondCutFacet(create2Salt: string, ethTxOptions: ethers.providers.TransactionRequest) {
        ...
        this.addresses.Micro.DiamondCutFacet = contractAddress;
    }
    ...
    public async deployGettersFacet(create2Salt: string, ethTxOptions: ethers.providers.TransactionRequest) {
        ...
        this.addresses.Micro.GettersFacet = contractAddress;
    }
    ...
    public async deployVerifier(create2Salt: string, ethTxOptions: ethers.providers.TransactionRequest) {
        ...
        this.addresses.Micro.Verifier = contractAddress;
    }
    ...
    public async deployERC20BridgeImplementation(
        ...
        const contractAddress = await this.deployViaCreate2(
            'L1ERC20Bridge',
            [this.addresses.Micro.DiamondProxy, this.addresses.AllowList],
            create2Salt,
            ethTxOptions
        );
    ...
    public async deployWethBridgeImplementation(
        ...
        const contractAddress = await this.deployViaCreate2(
            'L1WethBridge',
            [this.addresses.WethToken, this.addresses.Micro.DiamondProxy, this.addresses.AllowList],
            create2Salt,
            ethTxOptions
        );
    ...
    public async deployDiamondInit(create2Salt: string, ethTxOptions: ethers.providers.TransactionRequest) {
        ...
        this.addresses.Micro.DiamondInit = contractAddress;
    }
    ...
    public async deployDiamondUpgradeInit(
        ...
        this.addresses.Micro.DiamondUpgradeInit = contractAddress;
    }
    ...
    public async deployDiamondProxy(create2Salt: string, ethTxOptions: ethers.providers.TransactionRequest) {
        ...
        this.addresses.Micro.DiamondProxy = contractAddress;
    }

    public async deployMicroContract(create2Salt: string, gasPrice?: BigNumberish, nonce?) {
        nonce = nonce ? parseInt(nonce) : await this.deployWallet.getTransactionCount();

        // deploy micro contract
        const independentMicroDeployPromises = [
        ...
        await Promise.all(independentMicroDeployPromises);
        nonce += 7;
    ...
    public async deployValidatorTimelock(create2Salt: string, ethTxOptions: ethers.providers.TransactionRequest) {
        ...
        const contractAddress = await this.deployViaCreate2(
            'ValidatorTimelock',
            [this.governorAddress, this.addresses.Micro.DiamondProxy, executionDelay, validatorAddress],
            create2Salt,
            ethTxOptions
        );
    ...
    public microContract(signerOrProvider: Signer | providers.Provider) {
        return IMicroFactory.connect(this.addresses.Micro.DiamondProxy, signerOrProvider);
    }
