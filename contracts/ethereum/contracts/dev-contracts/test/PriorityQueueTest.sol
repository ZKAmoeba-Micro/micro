...
import "../../micro/libraries/PriorityQueue.sol";
...
contract PriorityQueueTest {
    ...
    function getByIndex(uint256 _index) external view returns (PriorityOperation memory) {
        return priorityQueue.getByIndex(_index);
    }
