...
/// @dev The address of the context PayToProver contract
address constant L2_PROOF_REWARD_POOL_CONTRACT_ADDR = address(0x8102);

/// @dev The L2 proof reward pool contract caller addr
address constant L2_PROOF_REWARD_POOL_CONTRACT_CALLER_ADDR = address(0x8104);
