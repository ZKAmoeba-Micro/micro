...
library Diamond {
    ...
    bytes32 constant DIAMOND_INIT_SUCCESS_RETURN_VALUE =
        0x33774e659306e47509050e97cb651e731180a42d458212294d30751925c551a2; // keccak256("diamond.micro.init") - 1
    ...
    event DiamondCut(bytes32 _diamondCutHash, address initAddress);
    ...
    function diamondCut(DiamondCutData memory _diamondCut) internal {
        ...
        bytes32 _diamondCutHash = keccak256(abi.encode(_diamondCut));
        emit DiamondCut(_diamondCutHash, initAddress);
    }
