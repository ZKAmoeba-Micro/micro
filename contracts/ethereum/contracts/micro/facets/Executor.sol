...
/// @title micro Executor contract capable of processing events emitted in the micro protocol.
/// @author Matter Labs
contract ExecutorFacet is Base, IExecutor {
    ...
    function executeBlocks(StoredBlockInfo[] calldata _blocksData) external payable nonReentrant onlyValidator {
