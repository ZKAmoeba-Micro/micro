...
contract L1WethBridge is IL1Bridge, AllowListed, ReentrancyGuard {
    ...
    function claimFailedDeposit(
        ...
        revert("Method not supported. ETH refund is handled by the micro contract.");
    }
    ...
    function finalizeWithdrawal(
        ...
        bool alreadyFinalised = micro.isEthWithdrawalFinalized(_l2MessageIndex, _l2TxNumberInBlock);
        if (alreadyFinalised) {
            ...
            bool success = micro.proveL2MessageInclusion(_l2BlockNumber, _l2MessageIndex, l2ToL1Message, _merkleProof);
            require(success, "vq");
        } else {
            // Finalize the withdrawal if it is not yet done.
            micro.finalizeEthWithdrawal(_l2BlockNumber, _l2MessageIndex, _l2TxNumberInBlock, _message, _merkleProof);
        }
