...
L2 transactions on-chain and publishing the state transition diff. zkAmoeba follows the second option.

See the [documentation](https://docs.zkamoeba.com/getting-started/intro-to-rollups) to read more!
...
Technically, this L1 smart contract acts as a connector between Ethereum (L1) and zkAmoeba (L2). This contract checks
the validity proof and data availability, handles L2 <-> L1 communication, finalizes L2 state transition, and more.
...
[docs](https://docs.zkamoeba.com/getting-started/l1-l2-interop.html).
...
An intermediate smart contract between the validator EOA account and the zkAmoeba smart contract. Its primary purpose is
to provide a trustless means of delaying block execution without modifying the main zkAmoeba contract. zkAmoeba actively
...
See the [documentation](https://docs.zkamoeba.com/building-on-zkamoeba-mirco/smart-contract-development) to read more!
