...
export async function snapshots_creator() {
    process.chdir(`${process.env.MICRO_HOME}`);
...
command
    ...
    .action(async (cmd: Command) => {
        ...
        const nodeUrls: Record<string, Environment> = {
            ...
            Stage: {
                httpMain: 'https://z2-dev-api.micro.dev:443',
                httpInstances: 'https://external-node-dev.micro.dev:443',
                wsMain: 'wss://z2-dev-api.micro.dev:443/ws',
                wsInstances: 'wss://external-node-dev.micro.dev:443/ws'
            },
            Testnet: {
                httpMain: 'https://micro2-testnet.micro.dev:443',
                httpInstances: 'https://external-node-testnet.micro.dev:443',
                wsMain: 'wss://micro2-testnet.micro.dev:443/ws',
                wsInstances: 'wss://external-node-testnet.micro.dev:443/ws'
            },
            Mainnet: {
                httpMain: 'https://micro2-mainnet.micro.io:443',
                httpInstances: 'https://external-node-mainnet.micro.dev:443',
                wsMain: 'wss://micro2-mainnet.micro.io:443/ws',
                wsInstances: 'wss://external-node-mainnet.micro.dev:443/ws'
            }
        };
