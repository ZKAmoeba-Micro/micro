...
export const DEFAULT_UPGRADE_PATH = process.env.MICRO_HOME + '/etc/upgrades';
export const DEFAULT_L2CONTRACTS_FOR_UPGRADE_PATH = process.env.MICRO_HOME + '/contracts/micro/contracts/upgrades';
export const DEFAULT_L1CONTRACTS_FOR_UPGRADE_PATH = process.env.MICRO_HOME + '/contracts/ethereum/contracts/upgrades';
