...
import type { IMicro } from './IMicro';

export class IMicroFactory {
    static connect(address: string, signerOrProvider: Signer | Provider): IMicro {
        return new Contract(address, _abi, signerOrProvider) as IMicro;
    }
}
