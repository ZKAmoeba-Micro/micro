...
4. `micro-address` - `CONTRACTS_DIAMOND_PROXY_ADDR`
...
Note: `micro-address` and `l1rpc` are required for correct generation of facet cuts, but they will be removed.
