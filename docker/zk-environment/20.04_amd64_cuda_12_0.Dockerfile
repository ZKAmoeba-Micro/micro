...
RUN wget -c https://github.com/ZKAmoeba-Micro/zksolc-bin/raw/main/linux-amd64/zksolc-linux-amd64-musl-v1.3.13 \
    && mv zksolc-linux-amd64-musl-v1.3.13 /usr/bin/zksolc \
    && chmod +x /usr/bin/zksolc

# Setup the environment
ENV MICRO_HOME=/usr/src/micro
ENV PATH="${MICRO_HOME}/bin:${PATH}"
ENV CI=1
