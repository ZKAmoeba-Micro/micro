...
[The LLVM IR generator code](https://github.com/ZKAmoeba-Micro/micro-compiler-llvm-context/blob/main/src/microvm/evm/arithmetic.rs#L15)
...
MicroVM can output the carry of the multiplication operation. In this case, the result is a tuple of two values: the
...
[The LLVM IR generator code](https://github.com/ZKAmoeba-Micro/micro-compiler-llvm-context/blob/main/src/microvm/evm/arithmetic.rs#L53)
is common for Yul and EVMLA representations.
...
[The LLVM IR generator code](https://github.com/ZKAmoeba-Micro/micro-compiler-llvm-context/blob/main/src/microvm/evm/arithmetic.rs#L34)
is common for Yul and EVMLA representations.
...
[The LLVM IR generator code](https://github.com/ZKAmoeba-Micro/micro-compiler-llvm-context/blob/main/src/microvm/evm/arithmetic.rs#L73)
is common for Yul and EVMLA representations.
...
[The LLVM IR generator code](https://github.com/ZKAmoeba-Micro/micro-compiler-llvm-context/blob/main/src/microvm/evm/arithmetic.rs#L162)
is common for Yul and EVMLA representations.
...
[The LLVM IR generator code](https://github.com/ZKAmoeba-Micro/micro-compiler-llvm-context/blob/main/src/microvm/evm/arithmetic.rs#L117)
is common for Yul and EVMLA representations.
...
[The LLVM IR generator code](https://github.com/ZKAmoeba-Micro/micro-compiler-llvm-context/blob/main/src/microvm/evm/arithmetic.rs#L236)
is common for Yul and EVMLA representations.
...
[The LLVM IR generator code](https://github.com/ZKAmoeba-Micro/micro-compiler-llvm-context/blob/main/src/microvm/evm/math.rs#L16)
is common for Yul and EVMLA representations.
...
[The LLVM IR generator code](https://github.com/ZKAmoeba-Micro/micro-compiler-llvm-context/blob/main/src/microvm/evm/math.rs#L43)
is common for Yul and EVMLA representations.
...
[The LLVM IR generator code](https://github.com/ZKAmoeba-Micro/micro-compiler-llvm-context/blob/main/src/microvm/evm/math.rs#L70)
is common for Yul and EVMLA representations.
...
[The LLVM IR generator code](https://github.com/ZKAmoeba-Micro/micro-compiler-llvm-context/blob/main/src/microvm/evm/math.rs#L93)
is common for Yul and EVMLA representations.
