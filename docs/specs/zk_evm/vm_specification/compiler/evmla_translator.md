...
eventually compiled to MicroVM assembly.
...
The optimized LLVM IR is translated into MicroVM assembly below, allowing the size comparable to the Yul pipeline.
...
For comparison, the Yul pipeline of solc v0.8.21 produces the following MicroVM assembly:
