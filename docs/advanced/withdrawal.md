# zkAmoeba deeper dive bridging stuff back (a.k.a withdrawals)

Assuming that we have the tools from part 1 installed, we can bridge the tokens back by simply calling the micro-cli:

```
npm exec micro-cli withdraw
```
...
```
npm exec micro-cli confirm_withdrawal
```
...
list here
[in github](https://github.com/zkamoeba/system-contracts/blob/436d57da2fb35c40e38bcb6637c3a090ddf60701/scripts/constants.ts#L29)

This is the place were we specify that `bootloader` is at address 0x8001, `NonceHolder` at 0x8003 etc.

This brings us to [L2EthToken.sol](https://github.com/zkamoeba/system-contracts/blob/main/contracts/L2EthToken.sol) that
has the implementation of the L2 Eth.
...
[Executor.sol](https://github.com/zkamoeba/micro-2-contracts/blob/main/ethereum/contracts/micro/facets/Executor.sol)
facet and you can look at
[README](https://github.com/zkamoeba/micro-2-contracts/blob/main/docs/Overview.md#executorfacet) to see the details of
