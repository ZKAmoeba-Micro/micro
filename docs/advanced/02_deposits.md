...
We'll use the micro-cli from: <https://github.com/ZKAmoeba-Micro/micro-cli> and then run:

```shell
npx micro-cli deposit --chain=local-dockerized
...
[Mailbox.sol](https://github.com/ZKAmoeba-Micro/micro-2-contracts/blob/main/ethereum/contracts/micro/facets/Mailbox.sol#L205)
...
[Contract docs](https://github.com/ZKAmoeba-Micro/micro-2-contracts/blob/main/docs/Overview.md)
...
[`loop_iteration` function](https://github.com/ZKAmoeba-Micro/micro-2-dev/blob/main/core/bin/micro_core/src/eth_watch/mod.rs#L128])
