...
```bash
npx micro-cli withdraw --chain=local-dockerized
```
...
```bash
npx micro-cli withdraw-finalize --chain=local-dockerized
```
...
list here
[in github](https://github.com/ZKAmoeba-Micro/system-contracts/blob/436d57da2fb35c40e38bcb6637c3a090ddf60701/scripts/constants.ts#L29)
