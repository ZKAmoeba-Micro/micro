...
We'll use the micro-cli from: <https://github.com/zkamoeba/micro-cli> and then run:

```shell
npm run build
npm exec micro-cli deposit
```
...
[Mailbox.sol](https://github.com/zkamoeba/micro-2-contracts/blob/main/ethereum/contracts/micro/facets/Mailbox.sol#L205)
...
[Contract docs](https://github.com/zkamoeba/micro-2-contracts/blob/main/docs/Overview.md)
...
[`loop_iteration` function](https://github.com/zkamoeba/micro-2-dev/blob/main/core/bin/micro_core/src/eth_watch/mod.rs#L128])
