...
// This checks the tokens on 'L2' (micro)
...
For an easy way to bridge we'll use [micro CLI](https://github.com/ZKAmoeba-Micro/micro-cli)

```shell
npx micro-cli bridge deposit --chain=local-dockerized
...
[Mailbox.sol](https://github.com/ZKAmoeba-Micro/micro-contracts/blob/f06a58360a2b8e7129f64413998767ac169d1efd/ethereum/contracts/micro/facets/Mailbox.sol#L220)
...
[Contract docs](https://github.com/ZKAmoeba-Micro/micro-contracts/blob/main/docs/Overview.md)
...
[`loop_iteration` function](https://github.com/ZKAmoeba-Micro/micro/blob/main/core/lib/micro_core/src/eth_watch/mod.rs#L163)
