...
need to filter all of the transactions to the L1 micro contract for only the `commitBlocks` transactions where the
...
### Compression of State Diffs in Post-Boojum micro
