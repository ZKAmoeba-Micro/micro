...
This documentation explains the basics of the micro External Node.
...
[zks_docs]: https://micro.micro.io/docs/api/api.html#micro-specific-json-rpc-methods
