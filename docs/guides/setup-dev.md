...
micro currently can be launched on any \*nix operating system (e.g. any linux distribution or MacOS).
...
1.67.1-aarch64-apple-darwin (overridden by '/Users/user/workspace/micro/rust-toolchain')
```
