...
4. Run the verification key
   [workflow](https://github.com/ZKAmoeba-Micro/micro/actions/workflows/fri-vk-generator.yaml) against the PR to
...
6. Run the cpu setup data generation
   [workflow](https://github.com/ZKAmoeba-Micro/micro/actions/workflows/fri-setup-data-generator.yml) against the PR
   to generate the cpu setup data.
7. Run the gpu setup data generation
   [workflow](https://github.com/ZKAmoeba-Micro/micro/actions/workflows/fri-gpu-setup-data-generator.yml) against the
...
9. Run the GPU integration test
   [workflow](https://github.com/ZKAmoeba-Micro/micro/actions/workflows/fri-gpu-prover-integration-test.yml) against
