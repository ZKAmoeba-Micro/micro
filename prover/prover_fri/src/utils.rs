...
use micro_prover_fri_types::circuit_definitions::boojum::config::ProvingCSConfig;
use micro_prover_fri_types::circuit_definitions::boojum::cs::implementations::reference_cs::CSReferenceAssembly;

use tokio::sync::Mutex;
use zkevm_test_harness::prover_utils::{verify_base_layer_proof, verify_recursion_layer_proof};
use micro_config::configs::fri_prover_group::CircuitIdRoundTuple;
...
use micro_prover_fri_types::circuit_definitions::boojum::cs::implementations::proof::Proof;
use micro_prover_fri_types::circuit_definitions::boojum::cs::implementations::verifier::VerificationKey;
use micro_prover_fri_types::circuit_definitions::boojum::field::goldilocks::{
...
pub async fn save_proof(
    ...
    let (circuit_type, is_scheduler_proof) = match &proof {
        ...
        FriProofWrapper::Recursive(recursive_circuit) => match recursive_circuit {
            MicroRecursionLayerProof::SchedulerCircuit(_) => {
