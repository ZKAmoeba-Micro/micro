...
use micro_types::circuit::GEOMETRY_CONFIG;

use micro_config::ProverConfigs;
use micro_types::circuit::{LEAF_SPLITTING_FACTOR, NODE_SPLITTING_FACTOR, SCHEDULER_UPPER_BOUND};
...
pub fn get_circuits_for_vk() -> anyhow::Result<Vec<MicroCircuit<Bn256, VmWitnessOracle<Bn256>>>> {
...
pub fn get_setup_key_write_file_path(circuit_type: u8) -> String {
    ...
    format!("{}/{}", micro_home, get_setup_key_filename(circuit_type))
}
