...
use micro_prover_fri_types::{
    circuit_definitions::{
        ...
        circuit_definitions::{
            base_layer::MicroBaseLayerCircuit, recursion_layer::MicroRecursiveLayerCircuit,
        },
...
#[cfg(feature = "gpu")]
use {
    micro_vk_setup_data_server_fri::GpuProverSetupData, shivini::cs::setup::GpuSetup,
