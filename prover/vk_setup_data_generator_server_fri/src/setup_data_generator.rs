...
use micro_vk_setup_data_server_fri::utils::{
...
use {
    ...
    micro_vk_setup_data_server_fri::GpuProverSetupData,
};
...
fn get_base_layer_circuit(
    id: u8,
) -> anyhow::Result<MicroBaseLayerCircuit<
    GoldilocksField,
...
fn get_recursive_circuit(id: u8) -> anyhow::Result<MicroRecursiveLayerCircuit> {
