...
pub fn get_leaf_circuits() -> anyhow::Result<Vec<MicroRecursiveLayerCircuit>> {
        ...
        (BaseLayerCircuitType::VM as u8)..=(BaseLayerCircuitType::L1MessagesHasher as u8)
    {
        ...
        let circuit = MicroRecursiveLayerCircuit::leaf_circuit_from_base_type(
...
pub fn get_node_circuit() -> anyhow::Result<MicroRecursiveLayerCircuit> {
    ...
    Ok(MicroRecursiveLayerCircuit::NodeLayerCircuit(circuit))
}

pub fn get_scheduler_circuit() -> anyhow::Result<MicroRecursiveLayerCircuit> {
...
#[allow(dead_code)]
fn get_recursive_layer_proofs() -> Vec<MicroRecursionProof> {
    ...
    let mut scheduler_proofs: Vec<MicroRecursionProof> = vec![];
    for recursive_circuit_type in (MicroRecursionLayerStorageType::LeafLayerCircuitForMainVM as u8)
...
fn get_circuits(
    ...
    let mut tree = MicroTestingTree::empty();
