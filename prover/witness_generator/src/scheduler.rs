...
use micro_prover_fri_types::circuit_definitions::circuit_definitions::recursion_layer::{
    ...
    MicroRecursiveLayerCircuit, SCHEDULER_CAPACITY,
};
use micro_prover_fri_types::circuit_definitions::recursion_layer_proof_config;
...
use micro_vk_setup_data_server_fri::get_recursive_layer_vk_for_circuit_type;
use micro_vk_setup_data_server_fri::utils::get_leaf_vk_params;

use crate::utils::{load_proofs_for_job_ids, SchedulerPartialInputWrapper};
use micro_dal::ConnectionPool;
use micro_object_store::{FriCircuitKey, ObjectStore, ObjectStoreFactory};
use micro_prover_fri_types::{get_current_pod_name, CircuitWrapper, FriProofWrapper};
...
pub struct SchedulerArtifacts {
    pub scheduler_circuit: MicroRecursiveLayerCircuit,
}
...
pub struct SchedulerWitnessGeneratorJob {
    ...
    scheduler_witness: SchedulerCircuitInstanceWitness<
        ...
        GoldilocksExt2,
    >,
    node_vk: MicroRecursionLayerVerificationKey,
}
...
impl SchedulerWitnessGenerator {
    ...
    pub fn process_job_sync(
        ...
        SchedulerArtifacts {
            scheduler_circuit: MicroRecursiveLayerCircuit::SchedulerCircuit(scheduler_circuit),
        }
    }
}
...
pub async fn prepare_job(
    ...
    let node_vk = get_recursive_layer_vk_for_circuit_type(
        MicroRecursionLayerStorageType::NodeLayerCircuit as u8,
