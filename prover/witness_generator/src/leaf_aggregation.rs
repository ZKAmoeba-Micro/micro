...
use micro_prover_fri_types::circuit_definitions::circuit_definitions::recursion_layer::MicroRecursiveLayerCircuit;
use micro_prover_fri_types::circuit_definitions::encodings::recursion_request::RecursionQueueSimulator;
use micro_prover_fri_types::{get_current_pod_name, FriProofWrapper};
...
use micro_types::proofs::{AggregationRound, LeafAggregationJobMetadata};
...
pub struct LeafAggregationArtifacts {
    ...
    pub aggregations: Vec<(
        ...
        MicroRecursiveLayerCircuit,
    )>,
    #[allow(dead_code)]
    closed_form_inputs: Vec<MicroBaseLayerClosedFormInput<GoldilocksField>>,
}
...
pub struct LeafAggregationWitnessGeneratorJob {
    ...
    pub(crate) proofs: Vec<MicroBaseLayerProof>,
    pub(crate) base_vk: MicroBaseLayerVerificationKey,
