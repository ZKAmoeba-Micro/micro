...
use micro_prover_fri_types::circuit_definitions::circuit_definitions::recursion_layer::{
    ...
    MicroRecursionLayerVerificationKey, MicroRecursiveLayerCircuit,
};
...
use micro_types::proofs::NodeAggregationJobMetadata;
...
pub struct NodeAggregationWitnessGeneratorJob {
    ...
    proofs: Vec<MicroRecursionLayerProof>,
    leaf_vk: MicroRecursionLayerVerificationKey,
