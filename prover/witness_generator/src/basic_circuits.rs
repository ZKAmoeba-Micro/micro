...
use micro_prover_fri_types::circuit_definitions::MicroDefaultRoundFunction;
use rand::Rng;
...
pub struct BasicCircuitArtifacts {
    basic_circuits: BlockBasicCircuits<GoldilocksField, MicroDefaultRoundFunction>,
...
async fn save_leaf_aggregation_artifacts(
    ...
    let round_function = MicroDefaultRoundFunction::default();
...
async fn generate_witness(
    ...
    BlockBasicCircuits<GoldilocksField, MicroDefaultRoundFunction>,
    ...
    let previous_batch_with_metadata = connection
        .blocks_dal()
        .get_l1_batch_metadata(micro_types::L1BatchNumber(
...
impl StoredObject for RunWithFixedParamsInput {
    ...
    micro_object_store::serialize_using_bincode!();
}
