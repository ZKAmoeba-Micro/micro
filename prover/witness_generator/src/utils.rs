use micro_prover_fri_types::circuit_definitions::boojum::field::goldilocks::GoldilocksExt2;
...
use micro_config::constants::USED_BOOTLOADER_MEMORY_BYTES;
...
use micro_prover_fri_types::{CircuitWrapper, FriProofWrapper};
...
pub struct ClosedFormInputWrapper(
    pub(crate) Vec<MicroBaseLayerClosedFormInput<GoldilocksField>>,
...
pub async fn save_base_prover_input_artifacts(
    ...
    circuits: BlockBasicCircuits<GoldilocksField, MicroDefaultRoundFunction>,
